...
import 'package:apollo/modals/register/register_confirm_password_step.dart';
...
class RegisterPasswordStep extends StatefulWidget {
  ...
  RegisterPasswordStep({Key? key, this.onNext}) : super(key: key);
            ...
            onPressed: () {
              if (_formKey.currentState!.validate()) {
                if (widget.onNext != null) {
                  ...
                  MutableModalContent.of(context)
                      .push(RegisterPasswordConfirmStep());
                }
              }
            },
          ),
